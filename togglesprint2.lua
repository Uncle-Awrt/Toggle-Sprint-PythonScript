...
aobscanmodule(INJECT,Minecraft.Windows.exe,41 8B 03 33 C9) // should be unique
...
{
// ORIGINAL CODE - INJECTION POINT: Minecraft.Windows.exe+2B07EEA
...
Minecraft.Windows.exe+2B07F05: 45 84 FF                 - test r15b,r15b
Minecraft.Windows.exe+2B07F08: 0F 84 F1 01 00 00        - je Minecraft.Windows.exe+2B080FF
}